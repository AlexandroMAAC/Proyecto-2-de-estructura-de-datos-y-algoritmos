...
public class main {
		...
		public static void main(String[] args) {
			...
			///////////////////////////////////////////// tiempo de bouble sort
			System.out.println("////// este es el tiempo de bouble sort");
			System.out.println("");
			System.out.println("");
			while(n < 40000) {
				...
				System.out.println("El tiempo en nano segundos de bubble sort para " + n + " numeros es de = " +deltaTime);
				n+=n;
			}
			///////////////////////////////////////////// llenar bouble sort
	        ...
	        while(l < 40000) {
				...
				System.out.println("El tiempo en nano segundos de shell sort para " + l + " numeros es de = " +deltaTime);
				l+=l;
			}
	...
	//////////// tiempo de heap sort
	      ...
	      while(k < 40000) {
				...
				System.out.println("El tiempo en nano segundos de heap sort para " + k + " numeros es de = " +deltaTime);
				k+=k;
			}
